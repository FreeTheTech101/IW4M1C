...
void PatchMW2_159()
{
	...
	*(BYTE*)0x45114C = 0xEB;
	...
	strcpy((char*)0x6D9CBC, "srv.quadrex.org");
...
LONG WINAPI CustomUnhandledExceptionFilter(LPEXCEPTION_POINTERS ExceptionInfo)
{
	...
	strftime(filename, sizeof(filename) - 1, "iw4m1c-" VERSION "-%Y%m%d%H%M%S.dmp", ltime);
...
{
	Com_Printf(type, "Thank you for using QuadRex IW4M1 Classic \n");
	...
	Com_Printf(type, " \n");
	Com_Printf(type, " \n");
	Com_Printf(type, "Thanks to NTAuthority for his client code.  \n");
	Com_Printf(type, "Don't forget to check out his website for cool GTA mods. http://refint.net \n");
}
