...
void PatchMW2_Branding()
{
	...
	*(DWORD*)0x60BD56 = (DWORD)(VERSIONSTRING " (built " __DATE__ " " __TIME__ ")");
	...
	// set fs_basegame to 'asset' (will apply before fs_game, unlike the above line)
	*(DWORD*)0x6431D1 = (DWORD)"asset";
	
	//set the config_mp.cfg to somewhere else to avoid conflects.
	strncpy((char*)0x6E08C0, "confM1_mp.cfg", 14);
